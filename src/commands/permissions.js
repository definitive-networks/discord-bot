  ...
  args: (client, guildId) => [
    {
      type: 'SUB_COMMAND',
      name: 'list',
      decription: 'List the permissions for a command.',
      options: [
        {
          type: 'STRING',
          name: 'command',
          description: 'The command to view permissions of.',
          required: true,
        },
      ],
    },
    {
      type: 'SUB_COMMAND',
      name: 'enable',
      description: 'Enable a command for a role, user, or channel.',
      options: [
        {
          type: 'STRING',
          name: 'command',
    ...
    },
    {
      type: 'SUB_COMMAND',
      name: 'disable',
      description: 'Disable a command for a role, user, or channel.',
      options: [
        {
          type: 'STRING',
          name: 'command',
